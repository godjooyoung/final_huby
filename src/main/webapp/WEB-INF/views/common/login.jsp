...
<body>
	<form id="frm" name="frm" method="post" action="PersonalLoginCheck.do"
		...
		<div align="center">
			<div class="member" style="display: inline-block">
				개인회원</br> <input type="text" name="member_id" id="member_id"
					maxlength="50" placeholder="ID"> <br>
				<br> <input type="password" name="member_pw" id="member_pw"
					maxlength="50" placeholder="PW"><br>
	...
	<form id="frm2" name="frm2" method="post" action="CompanyLoginCheck.do"
		onsubmit="return CompanyLoginCheck()">
		<div align="center">
			<div class="member" style="display: inline-block">
				기업회원</br> <input type="text" name="company_id" id="company_id"
					maxlength="50" placeholder="ID"> <br>
				<br> <input type="password" name="company_pw" id="company_pw"
					maxlength="50" placeholder="PW"><br>
				<br> <input type="submit" value="로그인">
	...
	<!-- test -->
	<button type="button" onclick="location.href='companyAfterLogin.do'">기업페이지타일즈
		테스트</button>
	<button type="button" onclick="location.href='index.do'">관리자페이지
		로그인 없음</button>
</body>
</html>