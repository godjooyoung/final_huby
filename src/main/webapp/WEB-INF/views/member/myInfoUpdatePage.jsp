...
<body>
<div>
<form class="form-horizontal" id="frm" name="frm" method="post" enctype="multipart/form-data" action="myInfoUpdate.do" onsubmit="return joincheck()">
    <fieldset style="padding: 20px 20px 20px 20px;">
		...
		<div class="form-group">
          ...
          <div class="col-md-4">
          <img src="${pageContext.request.contextPath}/resources/FileUpload/${mlist.member_photo }" style="width: 100px; height: 100px" alt="Avatar">
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
          <input class="form-control input-md" type="text" id="member_id" name="member_id" required="required" maxlength="20" value="${ mlist.member_id }" readonly="readonly">
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
          <input class="form-control input-md" text" id="member_name" name="member_name" required="required" maxlength="5" readonly="readonly" value="${ mlist.member_name }">
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
          <fmt:formatDate value="${ mlist.member_birth }" pattern="yyyy-MM-dd" var="member_birth" />
            <input class="form-control input-md" type="text" id="member_birth" name="" required="required" readonly="readonly" value="${ member_birth }" >
            <span class="help-block"></span>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <input class="form-control input-md" type="text" id="member_addr1" name="member_addr1" maxlength="50" value="${ mlist.member_addr }">
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
			<input class="form-control input-md" type="text" id="member_tel" name="member_tel" onblur="telcheck()" maxlength="13"  value="${ mlist.member_tel }">
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
			<input class="form-control input-md" type="text" id="member_email" name="member_email" onblur="emailcheck()" maxlength="30"  value="${ mlist.member_email }">
