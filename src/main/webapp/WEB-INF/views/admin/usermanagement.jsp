...
<div class="row" >
      <div id="middlegood1" onclick="location.href='personalmemberall.do'" class="col-sm-6" style="background-color:lightblue; height: 500px">개인회원</div>
      <div id="middlegood1" onclick="location.href='companymemberall.do'" class="col-sm-6" style="background-color:lightyellow; height: 500px">기업회원</div>
</div>
    <br>
