				...
				<ul class="list-group list-group-flush">
					<c:forEach var="employment" items="${employments}">
						...
						<form id="frm${employment.employment_id}">
							<input type="hidden" value="${employment.employment_id}"
								name="employment_id"> <input type="hidden"
								value="${employment.hope_job}" name="code_id">
						</form>
					</c:forEach>
				</ul>
			</div>
