...
<footer id="ft_wrap" class="center">
	<div class="ft_top">
		<img src="${pageContext.request.contextPath}/resources/img/common/ft_logo_w.png" />
	</div>
	<div class="ft_bt">
		<div class="ft_bt_btn">OIT 정보 보기</div>
		<div class="ft_bt_con">
			OIT<span>|</span><br class="mo"> 대표 : 예담인<span>|</span><br
				class="mo"> 사업자번호 : 삐삐삐-삐삐삐삐-삐삐삐삐삐<span>|</span><br class="mo">
			대구 중구<span>|</span><br class="mo"> 대표전화 : 안알려죵<br> <br
				class="mo">
		</div>
	...
	<br>
	<br>
	<div class="mt20" style="font-size: 0.8em; opacity: 0.5">
		홈페이지에 사용된 인물 이미지의 경우 예담인 이미지입니다.<br> (아니야 그냥 다 퍼왔어ㅋㅋㅋㅋㅋ)
	</div>
</footer>
<script>
	AOS.init({
