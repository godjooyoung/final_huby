...
<div class="w3-top">
  <div class="w3-white w3-xlarge" style="max-width:1200px;margin:auto">
    ...
    <div class="w3-right w3-padding-16"><a href="#" class="w3-bar-item w3-button">공고관리</a></div>
    <div class="w3-right w3-padding-16"><a href="#" class="w3-bar-item w3-button">지원관리</a></div>
    
    <div class="w3-right w3-padding-16"> 
    <div class="w3-dropdown-hover w3-right">
      <button class="w3-button">'기 업 명'님</button>
